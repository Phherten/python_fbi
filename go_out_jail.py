            ...
            if jailed.equal_seniority:
                ...
                for free_member in list_of_members:
                    ...
                    if free_member.name == jailed.equal_seniority.name:
                        ...
                        for sub in jailed.json_subordinates:
                            MafiaMember.add_boss(sub, jailed.name)
                            MafiaMember.del_subordinates(jailed.equal_seniority, sub.name)
                            # si los subordinados del preso están en los subordinatos del igual los borramos
